function Controller() {
    ...
    $.__views.NewPost.add($.__views.__alloyId166);
    ...
    $.__views.__alloyId166.add($.__views.streaming);
    ...
    $.__views.__alloyId166.add($.__views.textFldHide);
    ...
    addPhoto ? $.__views.__alloyId167.addEventListener("click", addPhoto) : __defers["$.__views.__alloyId167!click!addPhoto"] = true;
    ...
    $.__views.__alloyId166.add($.__views.postImage);
    ...
    $.__views.__alloyId166.add($.__views.high_prior);
    ...
    $.__views.__alloyId166.add($.__views.textFld);
    ...
    $.__views.NewPost.add($.__views.__alloyId168);
    ...
    closePopup ? $.__views.__alloyId169.addEventListener("click", closePopup) : __defers["$.__views.__alloyId169!click!closePopup"] = true;
    ...
    sendPost ? $.__views.__alloyId170.addEventListener("click", sendPost) : __defers["$.__views.__alloyId170!click!sendPost"] = true;
    ...
    __defers["$.__views.__alloyId167!click!addPhoto"] && $.__views.__alloyId167.addEventListener("click", addPhoto);
    ...
    __defers["$.__views.__alloyId169!click!closePopup"] && $.__views.__alloyId169.addEventListener("click", closePopup);
    __defers["$.__views.__alloyId170!click!sendPost"] && $.__views.__alloyId170.addEventListener("click", sendPost);
    _.extend($, exports);
}
