function Controller() {
    ...
    $.__views.MyNeighborhoods.add($.__views.__alloyId156);
    addComment ? $.__views.__alloyId156.addEventListener("click", addComment) : __defers["$.__views.__alloyId156!click!addComment"] = true;
    ...
    __defers["$.__views.__alloyId156!click!addComment"] && $.__views.__alloyId156.addEventListener("click", addComment);
    _.extend($, exports);
}
