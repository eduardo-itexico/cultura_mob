function Controller() {
    ...
    $.__views.commentView.add($.__views.__alloyId149);
    $.__views.imageUser = Ti.UI.createImageView({
        left: 0,
        width: 60,
        id: "imageUser"
    });
    $.__views.__alloyId149.add($.__views.imageUser);
    ...
    $.__views.__alloyId149.add($.__views.titleLbl);
    ...
    $.__views.__alloyId149.add($.__views.subTitleLbl);
    ...
    $.__views.__alloyId149.add($.__views.commentOptions);
    ...
    $.__views.commentView.add($.__views.__alloyId150);
    ...
    $.__views.__alloyId150.add($.__views.hrefLbl);
    ...
    $.__views.__alloyId150.add($.__views.textLbl);
    ...
    $.__views.__alloyId150.add($.__views.commentImage);
    ...
    $.__views.commentFooter.add($.__views.__alloyId151);
    ...
    likeComment ? $.__views.__alloyId152.addEventListener("click", likeComment) : __defers["$.__views.__alloyId152!click!likeComment"] = true;
    ...
    $.__views.__alloyId151.add($.__views.likeLbl);
    ...
    $.__views.commentFooter.add($.__views.__alloyId153);
    openNextWindow ? $.__views.__alloyId153.addEventListener("click", openNextWindow) : __defers["$.__views.__alloyId153!click!openNextWindow"] = true;
    ...
    $.__views.__alloyId153.add($.__views.repliesLbl);
    ...
    __defers["$.__views.__alloyId152!click!likeComment"] && $.__views.__alloyId152.addEventListener("click", likeComment);
    __defers["$.__views.__alloyId153!click!openNextWindow"] && $.__views.__alloyId153.addEventListener("click", openNextWindow);
    _.extend($, exports);
}
