function Controller() {
    ...
    $.__views.groupContainer.add($.__views.__alloyId204);
    ...
    $.__views.__alloyId204.add($.__views.titleLbl);
    ...
    addAddress ? $.__views.__alloyId205.addEventListener("click", addAddress) : __defers["$.__views.__alloyId205!click!addAddress"] = true;
    ...
    $.__views.searchContainer.add($.__views.__alloyId206);
    ...
    $.__views.groupListContainer.add($.__views.__alloyId207);
    ...
    $.__views.__alloyId207.add($.__views.groupListTitle);
    ...
    $.__views.recentlyFoundContainer.add($.__views.__alloyId208);
    ...
    $.__views.RightBarView.add($.__views.__alloyId210);
    ...
    __defers["$.__views.__alloyId205!click!addAddress"] && $.__views.__alloyId205.addEventListener("click", addAddress);
