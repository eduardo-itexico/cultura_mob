function Controller() {
    ...
    $.__views.RecentlyAddressRow.add($.__views.__alloyId212);
    addAddress ? $.__views.__alloyId212.addEventListener("click", addAddress) : __defers["$.__views.__alloyId212!click!addAddress"] = true;
    ...
    __defers["$.__views.__alloyId212!click!addAddress"] && $.__views.__alloyId212.addEventListener("click", addAddress);
    _.extend($, exports);
}
