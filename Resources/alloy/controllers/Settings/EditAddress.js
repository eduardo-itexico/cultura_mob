function Controller() {
    ...
    $.__views.container.add($.__views.__alloyId1062);
    ...
    $.__views.container.add($.__views.__alloyId1066);
    pickPlace ? $.__views.__alloyId1066.addEventListener("click", pickPlace) : __defers["$.__views.__alloyId1066!click!pickPlace"] = true;
    ...
    $.__views.__alloyId1066.add($.__views.faplace);
    $.__views.__alloyId1068 = Ti.UI.createImageView({
    ...
    $.__views.__alloyId1066.add($.__views.__alloyId1068);
    ...
    $.__views.container.add($.__views.__alloyId1069);
    ...
    $.__views.container.add($.__views.__alloyId1070);
    ...
    $.__views.container.add($.__views.__alloyId1074);
    pickCountry ? $.__views.__alloyId1074.addEventListener("click", pickCountry) : __defers["$.__views.__alloyId1074!click!pickCountry"] = true;
    ...
    $.__views.__alloyId1074.add($.__views.facountry);
    $.__views.__alloyId1076 = Ti.UI.createImageView({
        image: "/images/ic_down_arrow.png",
        right: 15,
        width: 12,
        height: 8,
    ...
    $.__views.state_row_picker.add($.__views.__alloyId1078);
    ...
    $.__views.__alloyId1078.add($.__views.fastate);
    $.__views.__alloyId1080 = Ti.UI.createImageView({
        image: "/images/ic_down_arrow.png",
        right: 15,
        width: 12,
        height: 8,
    ...
    $.__views.__alloyId1082.add($.__views.faenable);
    ...
    initialize();
    __defers["$.__views.__alloyId1066!click!pickPlace"] && $.__views.__alloyId1066.addEventListener("click", pickPlace);
    __defers["$.__views.__alloyId1074!click!pickCountry"] && $.__views.__alloyId1074.addEventListener("click", pickCountry);
