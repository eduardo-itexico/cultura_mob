function Controller() {
    ...
    $.__views.RetrievePassword.add($.__views.__alloyId66);
    send ? $.__views.__alloyId66.addEventListener("click", send) : __defers["$.__views.__alloyId66!click!send"] = true;
    ...
    __defers["$.__views.__alloyId66!click!send"] && $.__views.__alloyId66.addEventListener("click", send);
    _.extend($, exports);
}
