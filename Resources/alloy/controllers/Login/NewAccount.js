function Controller() {
    ...
    $.__views.__alloyId52.add($.__views.firstname);
    ...
    $.__views.__alloyId52.add($.__views.lastname);
    ...
    $.__views.__alloyId52.add($.__views.username);
    ...
    $.__views.__alloyId52.add($.__views.cellphone);
    ...
    $.__views.__alloyId54.add($.__views.tag_address);
    ...
    $.__views.__alloyId56.add($.__views.city);
    ...
    $.__views.__alloyId56.add($.__views.postal_code);
    ...
    $.__views.__alloyId58.add($.__views.country_row_picker);
    ...
    $.__views.country_row_picker.add($.__views.__alloyId59);
    ...
    $.__views.country_row_picker.add($.__views.__alloyId60);
    ...
    $.__views.__alloyId62.add($.__views.state_row_picker);
    ...
    $.__views.state_row_picker.add($.__views.__alloyId63);
    ...
    $.__views.state_row_picker.add($.__views.__alloyId64);
    $.__views.state_row_field = Ti.UI.createView({
        height: Ti.UI.SIZE,
        layout: "vertical",
        id: "state_row_field"
    });
    $.__views.__alloyId62.add($.__views.state_row_field);
    ...
    $.__views.__alloyId66.add($.__views.tag_password);
    ...
    $.__views.__alloyId70.add($.__views.agree_row);
    ...
    $.__views.agree_row.add($.__views.__alloyId71);
    ...
    $.__views.__alloyId71.add($.__views.i_accept);
    ...
    $.__views.__alloyId71.add($.__views.terms_and_cond);
    ...
    $.__views.agree_row.add($.__views.__alloyId72);
    toggleCheckbox ? $.__views.__alloyId72.addEventListener("click", toggleCheckbox) : __defers["$.__views.__alloyId72!click!toggleCheckbox"] = true;
    ...
    $.__views.__alloyId72.add($.__views.agree);
    ...
    __defers["$.__views.__alloyId72!click!toggleCheckbox"] && $.__views.__alloyId72.addEventListener("click", toggleCheckbox);
    _.extend($, exports);
}
