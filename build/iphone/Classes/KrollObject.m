...
//@interface AlertIDObject : NSObject
//@end

@interface AlertIDObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[AlertIDObject class]])
		{
			for (NSString *key in [[(AlertIDObject*)o modules] allKeys])
			{
