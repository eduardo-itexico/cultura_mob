...
/**
 The base class for all AlertID modules
 */
...
/**
 AlertID Platform calls this method on startup.
 */
-(void)startup;

/**
 AlertID Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 AlertID Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 AlertID Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 AlertID Platform calls this method on resume.
 @param sender The sender of the event.
 */
