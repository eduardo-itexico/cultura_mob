...
// in simulator we redefine to format for AlertID Developer console
...
{\
	NSString * exceptionName = [@"org.alertid." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alertid";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIAlertIDNativeItemNone = -1, 
	UIAlertIDNativeItemSpinner = -2,
	UIAlertIDNativeItemProgressBar = -3,
	
	UIAlertIDNativeItemSlider = -4,
	UIAlertIDNativeItemSwitch = -5,
	UIAlertIDNativeItemMultiButton = -6,
	UIAlertIDNativeItemSegmented = -7,
	
	UIAlertIDNativeItemTextView = -8,
	UIAlertIDNativeItemTextField = -9,
	UIAlertIDNativeItemSearchBar = -10,
	
	UIAlertIDNativeItemPicker = -11,
	UIAlertIDNativeItemDatePicker = -12,
	
	UIAlertIDNativeItemInfoLight = -13,
	UIAlertIDNativeItemInfoDark = -14,
	
	UIAlertIDNativeItemDisclosure = -15,
	
	UIAlertIDNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all AlertID instances of
